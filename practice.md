...
* Technical information about our hosting environment that we or our partners would prefer not to share. For example, we may wish to withhold some IP addresses (both internal and external) or other configuration management details. If something looks like an IP address, ask 18F Infrastructure before publishing that info.
